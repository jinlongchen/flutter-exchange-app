...
class ForgetEmailPage extends StatefulWidget {
  ...
  const ForgetEmailPage({Key key, this.onChange}) : super(key: key);

  @override
  _State createState() => new _State();
}

class _State extends State<ForgetEmailPage> with TickerProviderStateMixin {
  ...
  void getCode(){
    ...
    var params = {"account":_username.text};
    DioManager.getInstance().post(Url.USER_PWD_RESET_EMAIL, params, (data){
  ...
  void register(){
    ...
    var params={"account":_username.text,"code":_code.text,"mode":"1","password":CommonUtil.generateMd5(_password.text)};
