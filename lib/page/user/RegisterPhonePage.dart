...
class RegisterPhonePage extends StatefulWidget {
  ...
  const RegisterPhonePage({Key key, this.onChange}) : super(key: key);
...
class _State extends State<RegisterPhonePage> with TickerProviderStateMixin {
  ...
  void getCode(){
    ...
    var params = {"phone":_username.text,"country":country};
    DioManager.getInstance().post(Url.SMS_SEND, params, (data){
      startCountdown();
  ...
  void register(){
    ...
    var params={"phone":_username.text,"code":_code.text,"promotion":_inviteCode.text,"username":_username.text,"password":CommonUtil.generateMd5(_password.text),
    "country":country};

    DioManager.getInstance().post(Url.SMS_REGISTER, params, (data){
