...
class SafeAccountPwdResetPage extends StatefulWidget {
  @override
  _State createState() => new _State();
}

class _State extends State<SafeAccountPwdResetPage> {
  ...
  void _submit(){
    ...
    DioManager.getInstance().post(Url.USER_ACCOUNT_PWD_RESET, params, (data){
  ...
  void getCode(){
    ...
    _progressDialog.show();
    DioManager.getInstance().post(Url.USER_ACCOUNT_PWD_RESETCODE, null, (data){
      _progressDialog.hide();
      startCountdown();
