...
class SafePhonePage extends StatefulWidget {
  @override
  _State createState() => new _State();
}

class _State extends State<SafePhonePage> {
  ...
  void getCode(){
    ...
    _progressDialog.show();
    var params = {"phone":_username.text,"country":"中国"};
    DioManager.getInstance().post(Url.USER_BIND_PHONE_CODE, params, (data){
      _progressDialog.hide();
      startCountdown();
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Padding(
                      ...
                      child: Text('safe_sjbd'.tr(),style: TextStyle(fontSize: ScreenUtil().setSp(38)),),
                    ),
                    Padding(
                      padding: EdgeInsets.only(top: ScreenUtil().setHeight(80)),
                      child: Text('register_tel'.tr(),style: TextStyle(fontSize: ScreenUtil().setSp(24)),),
                    ),
                    Container(
