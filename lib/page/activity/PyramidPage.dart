...
import 'PyramidPoolPage.dart';
import 'PyramidSavePage.dart';


class PyramidPage extends StatefulWidget {

  const PyramidPage({Key key}) : super(key: key);
  @override
  _State createState() => new _State();
}

class _State extends State<PyramidPage> {
                ...
                child: Container(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        Row(
                          children: <Widget>[
                            Text('我的双星计划  ',style: TextStyle(color: Colours.dark_text_gray,fontSize: ScreenUtil().setSp(32),fontFamily: 'Din'),),
/*
                            Text(pyramidHomeData != null?pyramidHomeData.productTotal.toString():'',style: TextStyle(color: Colours.dark_accent_color,fontSize: ScreenUtil().setSp(24),fontFamily: 'Din'),)
*/
                          ],
                        ),
                        Row(
                          children: <Widget>[
                            Text(pyramidHomeData != null?pyramidHomeData.productNum.toString()+'个运行中':'',style: TextStyle(color: Colours.dark_accent_color,fontSize: ScreenUtil().setSp(32),fontFamily: 'Din'),),
