...
import 'PyramidRedeemPage.dart';

class PyramidMinePage extends StatefulWidget {
  @override
  _State createState() => new _State();
}

class _State extends State<PyramidMinePage> {
              ...
              children: <Widget>[
               ...
               /* GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: Text(item.status == 0?'复投':'全部赎回',style: TextStyle(color: Colors.white,fontSize: ScreenUtil().setSp(24)),),
                    ),
                  ),
              ...
              child: GestureDetector(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context) {
                    return PyramidRedeemPage();
                  }));
                },
                child: Center(
                    child: Row(
                      children: <Widget>[
                        Text('赎回记录',style: TextStyle(
