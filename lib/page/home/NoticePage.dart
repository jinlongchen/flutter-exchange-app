...
class _State extends State<NoticePage> {
  ...
  void initState() {
    super.initState();
    DioManager.getInstance().get("https://www.hibi.co/api/uc/v1/zendesk/sign?url=/api/v2/help_center/articles.json?label_names=landingpage&page=1&per_page=999&sort_by=created_at&sort_order=desc&nsukey=NbeSC6003lZenHJS%2BLMeDmjOEzPLTH04wITV2awEvQ4pBqQ5EqFDAFm94gDcLXL%2FiqOmiubWwIF980%2B3e%2FwklLOmooPiRgoxrVXevx3W1nAg1AiMquBBkjxMM3XHw2mRdoicdQuGz5Lk8O%2BkQWZL1fCj4hdr5DxlVXESTKcGHrnXZRQ0TfZGWfgHCIeq1Bo2y133eoOy5VsyV5SsbOus8g%3D%3D", null, (data){
    ...
    return InkWell(
      onTap: (){
        Navigator.push(context, MaterialPageRoute(builder: (context) {
          return WebPage(url: list[index]['html_url'],);
        }));
      },
      child: Container(
