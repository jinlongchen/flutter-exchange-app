...
class _State extends State<TradingPage>  {
          ...
          child: Stack(
            ...
            children: <Widget>[
              Container(
                ...
                height: double.infinity,
                color: Config.redColor.withOpacity(0.3),
              ),
              Padding(
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: <Widget>[
                    Expanded(
                      child:Text(item.price.toString(),style: TextStyle(color: Config.redColor,fontSize: ScreenUtil().setSp(24),fontFamily: 'Din'),),
                    ),
                    Expanded(
          ...
          child: Stack(
            ...
            children: <Widget>[
              Container(
                ...
                width: ScreenUtil().setWidth(314) * offset,
                height: double.infinity,
                color: Config.greenColor.withOpacity(0.3),
              ),
              Padding(
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: <Widget>[
                    Expanded(
                      child:Text(item.price.toString(),style: TextStyle(color: Config.greenColor,fontSize: ScreenUtil().setSp(24),fontFamily: 'Din'),),
                    ),
                    Expanded(
                      child: Text(item.volumn.toString(),style: TextStyle(color: Colours.dark_text_gray.withOpacity(0.3),fontSize: ScreenUtil().setSp(24),fontFamily: 'Din'),textAlign: TextAlign.right,),
                    )
