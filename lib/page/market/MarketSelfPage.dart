...
class MarketSelfPage extends StatefulWidget {
  @override
  _State createState() => new _State();
}

class _State extends State<MarketSelfPage> with AutomaticKeepAliveClientMixin {
  @override
  ...
  Widget _renderItem(dynamic object){
    return MarketItemView(itemObject: object,);
  }
                      ...
                      <Widget>[
                        ...
                        Consumer<SymbolState>(
                          builder: (context,symbolState,child){
                            List<SymbolListData> info = symbolState.getCollectSymbols();
                            if(sortPrice == 1){
