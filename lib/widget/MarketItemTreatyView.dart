...
class MarketItemTreatyView extends StatefulWidget{
  final TreatyListData itemObject;

  const MarketItemTreatyView({Key key, this.itemObject}) : super(key: key);
  @override
  _State createState() => new _State();

}

class _State extends State<MarketItemTreatyView> {
  ...
  @override
  void didUpdateWidget(MarketItemTreatyView oldWidget) {
  ...
  Widget build(BuildContext context) {
    TreatyListData itemObject = widget.itemObject;
    return Stack(
        ...
        Container(
          ...
          decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [isRise(itemObject.chg)?Config.greenColor.withOpacity(0.2):Config.redColor.withOpacity(0.2),isRise(itemObject.chg)?Config.greenColor.withOpacity(0.2):Config.redColor.withOpacity(0.2)],
