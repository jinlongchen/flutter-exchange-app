...
class MaterialSegmentedControl<T> extends StatefulWidget {
  ...
  MaterialSegmentedControl({
    ...
    this.horizontalPadding = _horizontalPadding, this.selectedTextColor, this.disabledTextColor,
...
class _SegmentedControlState<T> extends State<MaterialSegmentedControl<T>>
  ...
  bool _updateColors() {
    ...
    _unselectedTextColor = widget.unselectedColor;
  ...
  Color getTextColor(int index, T currentKey) {
    ...
    if (widget.selectionIndex == currentKey) return Config.accentColor;
