...
assetsBalanceEntityFromJson(AssetsBalanceEntity data, Map<String, dynamic> json) {
	...
	if (json['data'] != null) {
		data.data = new List<AssetsBalanceData>();
		(json['data'] as List).forEach((v) {
			data.data.add(new AssetsBalanceData().fromJson(v));
		});
	}
	return data;
}

Map<String, dynamic> assetsBalanceEntityToJson(AssetsBalanceEntity entity) {
...
assetsBalanceDataFromJson(AssetsBalanceData data, Map<String, dynamic> json) {
	if (json['id'] != null) {
	...
	if (json['coin'] != null) {
		data.coin = new AssetsBalanceDataCoin().fromJson(json['coin']);
	}
	if (json['balance'] != null) {
		data.balance = json['balance']?.toDouble();
	}
	if (json['frozenBalance'] != null) {
		data.frozenBalance = json['frozenBalance']?.toDouble();
	}
	...
	if (json['totalSum'] != null) {
		data.totalSum = json['totalSum'];
	}
	return data;
}

Map<String, dynamic> assetsBalanceDataToJson(AssetsBalanceData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
...
assetsBalanceDataCoinFromJson(AssetsBalanceDataCoin data, Map<String, dynamic> json) {
	if (json['name'] != null) {
...
Map<String, dynamic> assetsBalanceDataCoinToJson(AssetsBalanceDataCoin entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
